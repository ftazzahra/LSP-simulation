...
<form action="{{ route('data-siswa.update', $siswa->id) }}" class="mt-4" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')

    <div class="form-group" class="mt-4">
        <label for="nama">Nama</label>
        <input type="text" id="nama" style="width: 20rem;" name="nama" class="form-control" placeholder="Masukkan nama ..." value="{{ $siswa->nama }}">
    </div>
